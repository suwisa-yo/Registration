        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    <td> CPU </td>
                    <td> <input type="text" name="cpu_computer" id="cpu_computer" placeholder="CPU" /></td>
                    </tr>
                    <tr>
    <td>&nbsp;</td>
    </tr>
                    <tr>
                    <td> Main Memory&nbsp;</td>      
                    <td><input type="text" id="Main_Memory" name="Main_Memory" placeholder="Main Memory" /></td>
                    <td>Storage</td>
                    <td>
                    ...
                    <td>&nbsp;</td>
                     ...
                     <tr>
                      <td>Section</td>
                       <td><input type="text" name="section" id="section"placeholder="Section" /></td>
                       <td>Location</td>
