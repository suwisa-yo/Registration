								...
								<form class="form-horizontal" role="form">
									<div class="form-group"><!--Serial number-->
										...
										<div class="col-sm-8">
											...
											<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Brand  &nbsp;</label>
											<input type="text" id="form-field-1" placeholder="Brand" class="col-xs-8 col-sm-4" />
										</div>
									</div><!--Serial number,Brand-->

									<div class="form-group"><!--Main Memory-->
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Main Memory </label>

										<div class="col-sm-8">
											<input type="text" id="form-field-1" placeholder="Main Memory" class="col-xs-8 col-sm-4" />
